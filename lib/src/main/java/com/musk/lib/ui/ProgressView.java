...
public class ProgressView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mTextSize= typeArray.getDimension(R.styleable.TasksCompletedView_textSize, UIUtils.sp2px(context,20));
        Log.i("musk","===111=="+mTextSize);
        mTextSize= typeArray.getDimension(R.styleable.TasksCompletedView_textSize, TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_SP, 12,
                        getResources().getDisplayMetrics()));
        Log.i("musk","===222=="+mTextSize);
    }
